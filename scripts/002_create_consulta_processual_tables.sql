...
-- Política para permitir leitura apenas dos próprios registros (baseado no CPF)
CREATE POLICY "Permitir leitura próprias consultas" ON consultas_processuais
  FOR SELECT USING (true);

-- Política para permitir atualização apenas dos próprios registros
CREATE POLICY "Permitir atualização próprias consultas" ON consultas_processuais
